...
import { AbsoluteFill, Audio, Img, OffthreadVideo, Video, useCurrentFrame, useVideoConfig, Sequence} from 'remotion';
...
export const Comp: React.FC = () => {
  ...
  const volume =
    frame < 2500
      ? 0.5
      : frame < 2600
      ? 0.5 - ((frame - 2500) / 100) * (0.5 - 0.15)
      : frame < 56000
      ? 0.15
      : frame < 58130
      ? 0.15 - ((frame - 56000) / 2130) * 0.15
      : 0.15;

  const fadeStart = 127100;
  const fadeEnd = 127605;

  const opacity =
    frame < fadeStart ? 1 :
    frame > fadeEnd ? 0 :
    1 - (frame - fadeStart) / (fadeEnd - fadeStart);
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={20965}>
        ...
        <Video volume={0} style={{ opacity }} src="https://ben256.com/mohrta1.mp4"/>
        </AbsoluteFill>
      </Sequence>
      <Sequence from={20965}>
      ...
      <Sequence from={20400} durationInFrames={20965-20400}>
        ...
        <Img src="https://ben256.com/b/7233f917b58c10a7142cf20521fed8387d5d72ef6dbd8740d54990f017191fd2/pandoc-title-slide.png"/>
      </Sequence>
      <Sequence from={20965}>
      ...
      <Sequence from={58130}>
        <Audio volume={volume-0.05} src="https://ben256.com/b/20c52eac4eff2beb22a3b6a70eed772aa8eefd699e419b95b4a9ca1d70983f4e/spore2005-another-big-rock.mp3"/>
      </Sequence>
      <Sequence from={77979}>
        <Audio volume={volume-0.1} src="https://ben256.com/b/339573bccde4694b736fc4c68b4478e54537e41b67e124d18d881266fc500bc4/halo-ce-cloaked-in-blackness.mp3"/>
      </Sequence>
      <Sequence from={91127}>
        <Audio volume={volume-0.05} src="https://ben256.com/b/34b410903073211485553bf5716376aa1769da8e921635f6f8a1327851bd3eec/halo-ce-arborea-above.mp3"/>
      </Sequence>
      <Sequence from={96450}>
        <Audio volume={volume-0.05} src="https://ben256.com/b/8342c1ec08a89b53065bcac00b171f1fe9bac842a2f31a77267c1480f8a1100d/halo-ce-perchance-to-dream.mp3"/>
      </Sequence>
      ...
      <Sequence from={108050}>
        <Audio volume={volume-0.1} src="https://ben256.com/b/2f963093df3a418e2bc98f658cbbf0d91776f38cc4250fb7efe969a7695c45c8/halo-ce-to-sleep.mp3"/>
      </Sequence>
      <Sequence from={111800}>
        <Audio volume={volume-0.1} src="https://ben256.com/b/d02e232762feee7786ce675f0bdab8c34eb2b8c9a7486992241a5f7be993fe7c/halo-ce-didactic-principal.mp3"/>
      </Sequence>
      <Sequence from={118230}>
        <Audio volume={volume+0.2} src="https://ben256.com/b/7b04363a090294df8012aa71fb552417808ad13ca8e7a33ae2989b70a0220b7f/james-primate-mud-pits.mp3"/>
      </Sequence>
    </AbsoluteFill>
  );
};
